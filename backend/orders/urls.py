...
urlpatterns = [
    ...
    path('returns/admin/', views.AdminReturnListView.as_view(), name='order-return-admin-list'),
    path('returns/admin/<int:pk>/', views.AdminReturnDetailView.as_view(), name='order-return-admin-detail'),
    path('returns/admin/<int:pk>/refund/', views.AdminReturnRefundView.as_view(), name='order-return-admin-refund'),
